...
model = dict(
    ...
    min_depth = 0.1,
    max_depth = 100.0,
    depth_pretrained_path = '/content/logs/resnet50.pth',
    pose_pretrained_path =  '/content/logs/resnet18.pth',
    extractor_pretrained_path = '/content/drive/MyDrive/VinAI/Motion segmentation/FeatDepth/logs-step-6/epoch_30.pth',
